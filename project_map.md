...
/routes/automations_v2.py — API + UI Automations V2
(CRUD automazioni, capabilities, trigger/actions cross-app)
...
/tools/slack_processor.py — parse Slack events + context automazioni
...
/static/js/automations_v2.js — UI Automations V2
(CRUD automazioni, trigger Slack avanzati: channels / keywords / visibility)
...
(/api/connections/slack/<connection_id>/channels) pianificato ma non ancora implementato.

Versione

Versione: 2.1

Stato: allineata allo sviluppo corrente

Ultimo aggiornamento: Automations V2 UI + Slack trigger config