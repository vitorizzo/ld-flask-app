...
- pubblicazione immagini attiva anche su Poleepo tramite `PoleepoConnector.upload_image()` con endpoint upload configurabile; il connettore prova piu' candidati di path, nome campo file, upload da URL pubblica e PUT binario prima di fallire;
