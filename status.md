...
- scheda prodotto articoli:
  ...
  - l'upload Poleepo prova piu' candidati di path e di nome campo file (`image/file/media/upload`) prima di fallire, e riporta nel messaggio finale tutti i tentativi eseguiti;
