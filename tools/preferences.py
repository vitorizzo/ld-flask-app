...
PREFERENCE_DEFINITIONS: list[PreferenceDefinition] = [
    PreferenceDefinition(
        ...
        value_type="secret",
        default="",
        description="API key XPay v2 usata dal PayByLink amministrativo e, in assenza delle credenziali MAC, dal checkout HPP. Viene conservata cifrata.",
        config_key="NEXI_XPAY_API_KEY",
        sort_order=10,
    ),
    PreferenceDefinition(
        key="nexi_xpay.terminal_id",
        category="Nexi XPay",
        label="Terminal ID",
        default="",
        description="Identificativo del terminale comunicato da Nexi. Conservato come riferimento; il form Pagamento Semplice non lo trasmette.",
        config_key="NEXI_XPAY_TERMINAL_ID",
        sort_order=11,
    ),
    PreferenceDefinition(
        key="nexi_xpay.alias",
        category="Nexi XPay",
        label="Alias Pagamento Semplice",
        default="",
        description="Alias del profilo esercente usato dal checkout XPay classico.",
        config_key="NEXI_XPAY_ALIAS",
        sort_order=12,
    ),
    PreferenceDefinition(
        key="nexi_xpay.mac_key",
        category="Nexi XPay",
        label="Chiave MAC Pagamento Semplice",
        value_type="secret",
        default="",
        description="Segreto usato esclusivamente sul server per firmare e verificare il checkout XPay classico.",
        config_key="NEXI_XPAY_MAC_KEY",
        sort_order=13,
    ),
    PreferenceDefinition(
