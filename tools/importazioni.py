...
def _parse_registry_row(row, kind):
    ...
    payload = {
        ...
        "columns": {
            ...
            "8": vat_or_tax,
            "9": alternate_tax,
            "22": _clean_zero_value(_field(row, 22)),
            "23": _clean_registry_text(_field(row, 23)),
            "24": _clean_zero_value(_field(row, 24)),
            "25": _clean_registry_text(_field(row, 25)),
    ...
    return {
        ...
        "country": "IT",
        "category_code": _clean_zero_value(_field(row, 22)),
        "category_description": _clean_registry_text(_field(row, 23)),
        "subcategory_code": _clean_zero_value(_field(row, 24)),
        "subcategory_description": _clean_registry_text(_field(row, 25)),
