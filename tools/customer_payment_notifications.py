...
def notify_customer_payment_case(case_id):
    payment_case = (
    ...
    body = "\n".join([
        f"Nuova {subject_prefix.lower()} ricevuta da LDApp.",
        "",
    ...
    message = Message(
        subject=f"[LDApp] {subject_prefix} - {customer_name} - {payment_case.public_id[-8:]}",
