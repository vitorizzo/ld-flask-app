...
- 2026-06-18 correzione UI POS: il picker icone va inizializzato in `extra_js` dopo il bundle Bootstrap (non nel blocco content) e i logo dei circuiti vanno renderizzati tramite `settings.pos_circuit_logo`, non con `static` diretto.
