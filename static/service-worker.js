const CACHE_NAME = "ldapp-cache-v15"; // bump per forzare update
...
self.addEventListener("install", (event) => {
  ...
  event.waitUntil(
    caches.open(CACHE_NAME).then((cache) => {
      return cache.addAll([
        "/",
        "/static/css/style.css?v=20260628-mobile-home-3",
        "/static/css/context_tabs.css?v=20260628-mobile-home-3",
        "/static/css/task_status.css?v=20260628-mobile-home-3",
